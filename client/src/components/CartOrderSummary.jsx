...
import {
    Button, Text, Flex, Heading, Stack,
    useColorModeValue as mode, Badge
...
const CartOrderSummary = () => {
    ...
    return (
        <Stack spacing='8' borderWidth='1px' rounded='lg' padding='8' w='full'>
            ...
            <Button as={ReactLink} to='/checkout' colorScheme='orange' size='lg'
                fontSize='medium' rightIcon={<FaArrowRight />} isLoading={buttonLoading}
